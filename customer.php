        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
			  ...
			  <li class="nav-item"><img src="images/add-to-cart.png" alt="" >
...
<div class="text">
	and much more favourite ice creams...<button class="btn btn-group-lg"><a href="menu.php">More Flavours</a></button> 
</div>
